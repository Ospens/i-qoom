...
export const minLength2 = value => (
  value && value.length < 2 ? 'Must have at least 2 character' : undefined)

export const minLength3 = value => (
  value && value.length < 3 ? 'Must have at least 3 character' : undefined)

export const minLength4 = value => (
  value && value.length < 4 ? 'Must have at least 4 character' : undefined)

export const maxLength15 = value => (
  value && value.length > 15 ? 'Must be 15 characters or less' : undefined)

export const maxLength4 = value => (
