...
function MemberRow({
  ...
  const submitMember = useCallback(values => {
    return dispatch(startUpdateAccessMembers(project_id, values, type))
  }, [dispatch])
...
export default withRouter(connect(mapStateToProps)(reduxForm({ enableReinitialize: true })(MemberRow)))
